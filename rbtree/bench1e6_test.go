...
func BenchmarkSetErase1E6(b *testing.B) {
	b.N = 1e6
	var rand = benchRand
	var keys = make([]int, b.N)
...
func BenchmarkIntSetInsert1E6(b *testing.B) {
	b.N = 1e6
	var rand = benchRand
...
func BenchmarkIntSetErase1E6(b *testing.B) {
	b.N = 1e6
	var rand = benchRand
	var keys = make([]int, b.N)
	var set = rbtree.NewIntSet()
...
func BenchmarkIntSetInsertAndErase1E6(b *testing.B) {
	b.N = 1e6
	var rand = benchRand
	var keys = make([]int, b.N)
	var insertn, erasen int
...
func BenchmarkIntSetInsertAndEraseWithPool1E6(b *testing.B) {
	b.N = 1e6
	var rand = benchRand
	var nodePool = sync.Pool{New: func() interface{} {
