...
func BenchmarkIntSetInsert1E7(b *testing.B) {
	b.N = 1e7
	var rand = benchRand
...
func BenchmarkIntSetErase1E7(b *testing.B) {
	b.N = 1e7
	var rand = benchRand
	var keys = make([]int, b.N)
	var set = rbtree.NewIntSet()
...
func BenchmarkIntSetInsertAndErase1E7(b *testing.B) {
	b.N = 1e7
	var rand = benchRand
	var keys = make([]int, b.N)
	var insertn, erasen int
...
func BenchmarkIntSetInsertAndEraseWithPool1E7(b *testing.B) {
	b.N = 1e7
	var rand = benchRand
	var nodePool = sync.Pool{New: func() interface{} {
