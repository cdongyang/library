...
func BenchmarkSetInsert1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
...
func BenchmarkSetErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N)
...
func BenchmarkSetInsertAndErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N)
...
func BenchmarkSetInsertAndEraseWithPool1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
...
func BenchmarkIntSetInsert1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
...
func BenchmarkIntSetErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N)
	var set = rbtree.NewIntSet()
...
func BenchmarkIntSetInsertAndErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N)
	var insertn, erasen int
...
func BenchmarkIntSetInsertAndEraseWithPool1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var nodePool = sync.Pool{New: func() interface{} {
...
func BenchmarkSysHashMapInsert1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
...
func BenchmarkSysHashMapErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N)
	b.StopTimer()
...
func BenchmarkSysHashMapInsertAndErase1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
...
func BenchmarkSysHashMapInsertAndEraseWithBuf1E4(b *testing.B) {
	b.N = 1e4
	var rand = benchRand
	var keys = make([]int, b.N/10)
	var insertn, erasen int
