...
func BenchmarkIntSetInsert1E3(b *testing.B) {
	b.N = 1e3
	var rand = benchRand
...
func BenchmarkIntSetErase1E3(b *testing.B) {
	b.N = 1e3
	var rand = benchRand
	var keys = make([]int, b.N)
	var set = rbtree.NewIntSet()
...
func BenchmarkIntSetInsertAndErase1E3(b *testing.B) {
	b.N = 1e3
	var rand = benchRand
	var keys = make([]int, b.N)
	var insertn, erasen int
...
func BenchmarkIntSetInsertAndEraseWithPool1E3(b *testing.B) {
	b.N = 1e3
	var rand = benchRand
	var nodePool = sync.Pool{New: func() interface{} {
